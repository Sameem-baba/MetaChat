...
function Header() {
    ...
    return (
        <div className={`sticky top-3 m-5 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-60 p-5 rounded-xl shadow-2xl z-50 text-purple-500 border-b-2 border-purple-500`}>
